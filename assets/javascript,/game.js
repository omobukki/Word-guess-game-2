// First let's create an array with letters from the alphabet
var alphabet = ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z'];

// Library of cities 
var cities = ["New York", "Seattle", "Chicago", "Houston", "Los Angeles", "Miami", "New Orleans", "Dallas", "Boston", "Las Vegas", "Portland", "Detroit", "Cleveland", "Indianapolis", "Phoenix", ]
...
var numLosses = 0;
var getNewWord;
var wordPlace; //Index in cities array
var correctGuesses;
var wordAsArr = [];
var dashesArray =[];
...
function initialize() {
	...
	currentWord = cities[wordPlace];			//string
